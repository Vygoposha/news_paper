...
urlpatterns = [
    ...
    path('post/<int:pk>/', NewDetailView.as_view(), name = 'detail_news'),
    path('search/', NewsSearch.as_view(), name = 'search'),
    path('add/', NewsCreate.as_view(), name ='create_news'),
    path('post/<int:pk>/edit/', NewEdit.as_view(), name ='edit_news'),
    path('post/<int:pk>/delete/', NewDelete.as_view(), name ='delete_news'),
